...
class CorrectAnswerTestRunner:
    ...
    def get_correct_answers_for_exercise(self, exercise_num, dataset_num):
    ...
    def test_exercise_with_dataset(self, exercise_num, dataset_num):
        """Test an exercise with correct answers for a specific dataset."""
        self.log(f"Testing Exercise {exercise_num} with Dataset {dataset_num}")
        
        # Get correct answers for this exercise
        correct_answers = self.get_correct_answers_for_exercise(exercise_num, dataset_num)
        ...
        # Load dataset
        inputs.append("1")  # Load dataset
        inputs.append(str(dataset_num))  # Dataset number
        
        # Run exercise
        inputs.append("3")  # Run exercise
        ...
        if success:
            ...
            if success_count > 0:
                self.log(f"  Exercise {exercise_num} with Dataset {dataset_num}: PASS ({success_count} tasks completed)", "PASS")
            else:
    ...
    def run_all_tests(self):
        ...
        print("Testing each exercise with each dataset (3 datasets × 5 exercises = 15 tests)")
        print("="*70)
        ...
        for dataset_num in datasets:
            ...
            for exercise_num in exercises:
                self.test_exercise_with_dataset(exercise_num, dataset_num)
