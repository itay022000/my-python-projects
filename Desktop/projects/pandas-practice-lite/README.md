...
- **Use Cases**: Filtering, grouping, aggregations, data manipulation, data cleaning
...
5. **Clean Real Data**: Practice data cleaning techniques with the available datasets
